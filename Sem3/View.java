...
public class View { //The View class is responsible for interacting with the user and displaying information. It has a reference to the Controller, which it uses to perform actions and retrieve data to display.

    private Controller controller;

    public View(Controller controller) { // Initializes the view with the given controller. It also sets up some mock data for testing purposes.
